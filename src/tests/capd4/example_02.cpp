...
int main() {
  try {
    ...
    IMap vectorField("var:z_2_0, y_2_0, x_2_0, tau_2_0, omega2_2_0, omega1_2_0;fun:-((((-0.800000)*sin(((omega2_2_0+2.000000)*tau_2_0)))*cos(omega1_2_0))*2.000000), -((((-1.200000)*sin(((omega1_2_0+1.000000)*tau_2_0)))*sin(omega2_2_0))*2.000000), -((-1.000000)*sin((3.140000*tau_2_0))), -1.000000, -(0.000000+((-1)*omega2_2_0)), -(0.000000+((-1)*(0.500000*omega1_2_0)));");
