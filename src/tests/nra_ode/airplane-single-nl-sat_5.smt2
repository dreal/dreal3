...
(assert (<= -1.5 r_4_0)) (assert (<= r_4_0 1.5))
(assert (<= -1.5 r_4_t)) (assert (<= r_4_t 1.5))
(assert (<= -1.5 psi_4_0)) (assert (<= psi_4_0 1.5))
(assert (<= -1.5 psi_4_t)) (assert (<= psi_4_t 1.5))
(assert (<= -1.5 phi_4_0)) (assert (<= phi_4_0 1.5))
(assert (<= -1.5 phi_4_t)) (assert (<= phi_4_t 1.5))
(assert (<= -1.5 p_4_0)) (assert (<= p_4_0 1.5))
(assert (<= -1.5 p_4_t)) (assert (<= p_4_t 1.5))
...
(assert (<= -3.14159 gDir_4_0)) (assert (<= gDir_4_0 3.14159))
(assert (<= -3.14159 gDir_4_t)) (assert (<= gDir_4_t 3.14159))
...
(assert (<= -1.5 r_5_0)) (assert (<= r_5_0 1.5))
(assert (<= -1.5 r_5_t)) (assert (<= r_5_t 1.5))
(assert (<= -1.5 psi_5_0)) (assert (<= psi_5_0 1.5))
(assert (<= -1.5 psi_5_t)) (assert (<= psi_5_t 1.5))
(assert (<= -1.5 phi_5_0)) (assert (<= phi_5_0 1.5))
(assert (<= -1.5 phi_5_t)) (assert (<= phi_5_t 1.5))
(assert (<= -1.5 p_5_0)) (assert (<= p_5_0 1.5))
(assert (<= -1.5 p_5_t)) (assert (<= p_5_t 1.5))
...
(assert (<= -3.14159 gDir_5_0)) (assert (<= gDir_5_0 3.14159))
(assert (<= -3.14159 gDir_5_t)) (assert (<= gDir_5_t 3.14159))
...
(assert (or (and (= modeA_2 true) (= modeR_2 true)
                 (= [xRDR_2_t xAIL_2_t tau_2_t r_2_t psi_2_t
                     phi_2_t p_2_t gRDR_2_t gAIL_2_t gDir_2_t beta_2_t]
                    (integral 0. time_2 
                       [xRDR_2_0 xAIL_2_0 tau_2_0 r_2_0 psi_2_0 
                        phi_2_0 p_2_0 gRDR_2_0 gAIL_2_0 gDir_2_0 beta_2_0] flow_1)))
            (and (= modeA_2 true) (= modeR_2 false)
                 (= [xRDR_2_t xAIL_2_t tau_2_t r_2_t psi_2_t
                     phi_2_t p_2_t gRDR_2_t gAIL_2_t gDir_2_t beta_2_t]
                    (integral 0. time_2 
                       [xRDR_2_0 xAIL_2_0 tau_2_0 r_2_0 psi_2_0 
                        phi_2_0 p_2_0 gRDR_2_0 gAIL_2_0 gDir_2_0 beta_2_0] flow_2)))
            (and (= modeA_2 false) (= modeR_2 true)
                 (= [xRDR_2_t xAIL_2_t tau_2_t r_2_t psi_2_t
                     phi_2_t p_2_t gRDR_2_t gAIL_2_t gDir_2_t beta_2_t]
                    (integral 0. time_2 
                       [xRDR_2_0 xAIL_2_0 tau_2_0 r_2_0 psi_2_0 
                        phi_2_0 p_2_0 gRDR_2_0 gAIL_2_0 gDir_2_0 beta_2_0] flow_3)))
            (and (= modeA_2 false) (= modeR_2 false)
                 (= [xRDR_2_t xAIL_2_t tau_2_t r_2_t psi_2_t
                     phi_2_t p_2_t gRDR_2_t gAIL_2_t gDir_2_t beta_2_t]
                    (integral 0. time_2 
                       [xRDR_2_0 xAIL_2_0 tau_2_0 r_2_0 psi_2_0 
                        phi_2_0 p_2_0 gRDR_2_0 gAIL_2_0 gDir_2_0 beta_2_0] flow_4)))))
...
(assert (or (and (= modeA_3 true) (= modeR_3 true)
                 (= [xRDR_3_t xAIL_3_t tau_3_t r_3_t psi_3_t
                     phi_3_t p_3_t gRDR_3_t gAIL_3_t gDir_3_t beta_3_t]
                    (integral 0. time_3 
                       [xRDR_3_0 xAIL_3_0 tau_3_0 r_3_0 psi_3_0 
                        phi_3_0 p_3_0 gRDR_3_0 gAIL_3_0 gDir_3_0 beta_3_0] flow_1)))
            (and (= modeA_3 true) (= modeR_3 false)
                 (= [xRDR_3_t xAIL_3_t tau_3_t r_3_t psi_3_t
                     phi_3_t p_3_t gRDR_3_t gAIL_3_t gDir_3_t beta_3_t]
                    (integral 0. time_3 
                       [xRDR_3_0 xAIL_3_0 tau_3_0 r_3_0 psi_3_0 
                        phi_3_0 p_3_0 gRDR_3_0 gAIL_3_0 gDir_3_0 beta_3_0] flow_2)))
            (and (= modeA_3 false) (= modeR_3 true)
                 (= [xRDR_3_t xAIL_3_t tau_3_t r_3_t psi_3_t
                     phi_3_t p_3_t gRDR_3_t gAIL_3_t gDir_3_t beta_3_t]
                    (integral 0. time_3 
                       [xRDR_3_0 xAIL_3_0 tau_3_0 r_3_0 psi_3_0 
                        phi_3_0 p_3_0 gRDR_3_0 gAIL_3_0 gDir_3_0 beta_3_0] flow_3)))
            (and (= modeA_3 false) (= modeR_3 false)
                 (= [xRDR_3_t xAIL_3_t tau_3_t r_3_t psi_3_t
                     phi_3_t p_3_t gRDR_3_t gAIL_3_t gDir_3_t beta_3_t]
                    (integral 0. time_3 
                       [xRDR_3_0 xAIL_3_0 tau_3_0 r_3_0 psi_3_0 
                        phi_3_0 p_3_0 gRDR_3_0 gAIL_3_0 gDir_3_0 beta_3_0] flow_4)))))
(assert (and (= tau_3_t 0.5)         (= tau_4_0 0)
             (= gRDR_4_0 (* beta_3_t 0.35))
             (= gAIL_4_0 (* (- gDir_3_t (/ (* psi_3_t 180) 3.14)) 0.5))
             (= psi_4_0 psi_3_t)   (= phi_4_0 phi_3_t) 
             (= r_4_0 r_3_t)       (= p_4_0 p_3_t) 
             (= gDir_4_0 gDir_3_t) (= beta_4_0 beta_3_t)))
...
(assert (or (and (= modeA_4 true) (= modeR_4 true)
                 (= [xRDR_4_t xAIL_4_t tau_4_t r_4_t psi_4_t
                     phi_4_t p_4_t gRDR_4_t gAIL_4_t gDir_4_t beta_4_t]
                    (integral 0. time_4 
                       [xRDR_4_0 xAIL_4_0 tau_4_0 r_4_0 psi_4_0 
                        phi_4_0 p_4_0 gRDR_4_0 gAIL_4_0 gDir_4_0 beta_4_0] flow_1)))
            (and (= modeA_4 true) (= modeR_4 false)
                 (= [xRDR_4_t xAIL_4_t tau_4_t r_4_t psi_4_t
                     phi_4_t p_4_t gRDR_4_t gAIL_4_t gDir_4_t beta_4_t]
                    (integral 0. time_4 
                       [xRDR_4_0 xAIL_4_0 tau_4_0 r_4_0 psi_4_0 
                        phi_4_0 p_4_0 gRDR_4_0 gAIL_4_0 gDir_4_0 beta_4_0] flow_2)))
            (and (= modeA_4 false) (= modeR_4 true)
                 (= [xRDR_4_t xAIL_4_t tau_4_t r_4_t psi_4_t
                     phi_4_t p_4_t gRDR_4_t gAIL_4_t gDir_4_t beta_4_t]
                    (integral 0. time_4 
                       [xRDR_4_0 xAIL_4_0 tau_4_0 r_4_0 psi_4_0 
                        phi_4_0 p_4_0 gRDR_4_0 gAIL_4_0 gDir_4_0 beta_4_0] flow_3)))
            (and (= modeA_4 false) (= modeR_4 false)
                 (= [xRDR_4_t xAIL_4_t tau_4_t r_4_t psi_4_t
                     phi_4_t p_4_t gRDR_4_t gAIL_4_t gDir_4_t beta_4_t]
                    (integral 0. time_4 
                       [xRDR_4_0 xAIL_4_0 tau_4_0 r_4_0 psi_4_0 
                        phi_4_0 p_4_0 gRDR_4_0 gAIL_4_0 gDir_4_0 beta_4_0] flow_4)))))
(assert (and (= tau_4_t 0.5)         (= tau_5_0 0)
             (= gRDR_5_0 (* beta_4_t 0.35))
             (= gAIL_5_0 (* (- gDir_4_t (/ (* psi_4_t 180) 3.14)) 0.5))
             (= psi_5_0 psi_4_t)   (= phi_5_0 phi_4_t) 
             (= r_5_0 r_4_t)       (= p_5_0 p_4_t) 
             (= gDir_5_0 gDir_4_t) (= beta_5_0 beta_4_t)))
(assert (and (= xAIL_5_0 xAIL_4_t)))
(assert (or (and (>= gAIL_4_t xAIL_4_t) (= modeA_5 true))
            (and (<  gAIL_4_t xAIL_4_t) (= modeA_5 false))))
...
(assert (or (and (= modeA_5 true) (= modeR_5 true)
                 (= [xRDR_5_t xAIL_5_t tau_5_t r_5_t psi_5_t
                     phi_5_t p_5_t gRDR_5_t gAIL_5_t gDir_5_t beta_5_t]
                    (integral 0. time_5 
                       [xRDR_5_0 xAIL_5_0 tau_5_0 r_5_0 psi_5_0 
                        phi_5_0 p_5_0 gRDR_5_0 gAIL_5_0 gDir_5_0 beta_5_0] flow_1)))
            (and (= modeA_5 true) (= modeR_5 false)
                 (= [xRDR_5_t xAIL_5_t tau_5_t r_5_t psi_5_t
                     phi_5_t p_5_t gRDR_5_t gAIL_5_t gDir_5_t beta_5_t]
                    (integral 0. time_5 
                       [xRDR_5_0 xAIL_5_0 tau_5_0 r_5_0 psi_5_0 
                        phi_5_0 p_5_0 gRDR_5_0 gAIL_5_0 gDir_5_0 beta_5_0] flow_2)))
            (and (= modeA_5 false) (= modeR_5 true)
                 (= [xRDR_5_t xAIL_5_t tau_5_t r_5_t psi_5_t
                     phi_5_t p_5_t gRDR_5_t gAIL_5_t gDir_5_t beta_5_t]
                    (integral 0. time_5 
                       [xRDR_5_0 xAIL_5_0 tau_5_0 r_5_0 psi_5_0 
                        phi_5_0 p_5_0 gRDR_5_0 gAIL_5_0 gDir_5_0 beta_5_0] flow_3)))
            (and (= modeA_5 false) (= modeR_5 false)
                 (= [xRDR_5_t xAIL_5_t tau_5_t r_5_t psi_5_t
                     phi_5_t p_5_t gRDR_5_t gAIL_5_t gDir_5_t beta_5_t]
                    (integral 0. time_5 
                       [xRDR_5_0 xAIL_5_0 tau_5_0 r_5_0 psi_5_0 
                        phi_5_0 p_5_0 gRDR_5_0 gAIL_5_0 gDir_5_0 beta_5_0] flow_4)))))
(assert (< (^ (^ beta_5_t 2) 0.5) 1))
(check-sat)
(exit)
