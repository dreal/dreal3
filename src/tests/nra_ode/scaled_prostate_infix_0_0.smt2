...
(assert (<= 1 mode_0))
(assert (<= mode_0 2))
(assert (and (and (= tau_0_0 0) (= v_0_0 15.1) (= z_0_0 30) (= y_0_0 0.1) (= x_0_0 15)) (= mode_0 2) (= [tau_0_t v_0_t x_0_t y_0_t z_0_t] (integral 0. time_0 [tau_0_0 v_0_0 x_0_0 y_0_0 z_0_0] flow_2)) (= mode_0 2) (forall_t 2 [0 time_0] (>= x_0_t 0)) (>= x_0_t 0) (>= x_0_0 0) (forall_t 2 [0 time_0] (>= y_0_t 0)) (>= y_0_t 0) (>= y_0_0 0) (forall_t 2 [0 time_0] (>= z_0_t 0)) (>= z_0_t 0) (>= z_0_0 0) (forall_t 2 [0 time_0] (>= v_0_t 0)) (>= v_0_t 0) (>= v_0_0 0) (forall_t 2 [0 time_0] (>= tau_0_t 0)) (>= tau_0_t 0) (>= tau_0_0 0) (= mode_0 2) (= tau_0_t 400) (>= v_0_t 0) (>= z_0_t 0) (>= y_0_t 0) (>= x_0_t 0)))
(check-sat)
(exit)
