...
(assert (or (and (<= x3_3_t 20) (= mode_3_4 2))
            (and (> x3_3_t 20) (= mode_3_4 1))))
...
(assert (or (< x1_4_t (- 20 5)) (> x1_4_t (+ 20 5))))
(assert (or (< x2_4_t (- 20 5)) (> x2_4_t (+ 20 5))))
(assert (or (< x3_4_t (- 20 5)) (> x3_4_t (+ 20 5))))
(check-sat)
(exit)
