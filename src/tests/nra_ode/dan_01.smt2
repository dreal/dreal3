...
(define-ode flow_0 ((= d/dt[happening] 1)(= d/dt[fuellevel_gen] (+ (* gamma_generate_gen (* -1.0 1)) (* gamma_refuel_gen_tank1 2) ))(= d/dt[capacity_gen] 0)(= d/dt[gamma_generate_gen] 0)(= d/dt[gamma_refuel_gen_tank1] 0)))
(define-ode flow_1 ((= d/dt[happening] 1)(= d/dt[fuellevel_gen] (+ (* gamma_generate_gen (* -1.0 1)) (* gamma_refuel_gen_tank1 2) ))(= d/dt[capacity_gen] 0)(= d/dt[gamma_generate_gen] 0)(= d/dt[gamma_refuel_gen_tank1] 0)))
(define-ode flow_2 ((= d/dt[happening] 1)(= d/dt[fuellevel_gen] (+ (* gamma_generate_gen (* -1.0 1)) (* gamma_refuel_gen_tank1 2) ))(= d/dt[capacity_gen] 0)(= d/dt[gamma_generate_gen] 0)(= d/dt[gamma_refuel_gen_tank1] 0)))
(define-ode flow_3 ((= d/dt[happening] 1)(= d/dt[fuellevel_gen] (+ (* gamma_generate_gen (* -1.0 1)) (* gamma_refuel_gen_tank1 2) ))(= d/dt[capacity_gen] 0)(= d/dt[gamma_generate_gen] 0)(= d/dt[gamma_refuel_gen_tank1] 0)))
