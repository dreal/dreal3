...
#ifdef LINT_ARGS
local double q_p1l1(int m, double fg, double fk, double y)
#else
local double q_p1l1(m,fg,fk,y)
...
#ifdef LINT_ARGS
local double q_p2l1(double fk)
#else
local double q_p2l1(fk)
...
#ifdef LINT_ARGS
local double q_log1(double x)
#else
local double q_log1(x)
...
#ifdef LINT_ARGS
local double q_l1p1(double x)
#else
local double q_l1p1(x)
