...
#include "capd/interval/Interval_Friend.h"
//=================================================
...
//======== definitions in intervalBase.h ==========================
 ...
 // Interval( const T_Scalar & A_scalar );
  ...
  const T_Bound & leftBound() const;  ///<  returns the left end of the interval
  const T_Bound & rightBound() const; ///<  returns the right end of the interval
...
#include "capd/interval/Interval_FriendInternal.h"
...
protected:
  T_Bound   m_left,    ///< left end of an interval
...
///minimum
template < typename T_Bound, typename T_Rnd>
inline intervals::Interval< T_Bound, T_Rnd> min (const intervals::Interval< T_Bound, T_Rnd>& A_iv1,
                                                 const intervals::Interval< T_Bound, T_Rnd>& A_iv2)
{
   return intervals::Interval< T_Bound, T_Rnd>(
                  (A_iv1.leftBound()<A_iv2.leftBound() ? A_iv1.leftBound() : A_iv2.leftBound()),
...
#include "capd/interval/Interval_Base.h"

// deprecated functions
#include "capd/interval/Interval_Deprecated.h"
