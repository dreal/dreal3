...
template < typename T_Bound, typename T_Rnd> 
inline const T_Bound & Interval<T_Bound, T_Rnd>::leftBound() const
{
  return m_left;
}

template < typename T_Bound, typename T_Rnd> 
inline const T_Bound & Interval<T_Bound, T_Rnd>::rightBound() const
{
  return m_right;
}
...
{
  return Interval< T_Bound, T_Rnd > ( m_left );
}

template < typename T_Bound, typename T_Rnd> 
inline Interval< T_Bound, T_Rnd >  Interval<T_Bound, T_Rnd>::right() const
{
  return Interval<T_Bound, T_Rnd>( m_right );
}
