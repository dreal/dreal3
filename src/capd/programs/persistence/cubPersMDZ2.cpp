...
*/
  ...
  string executableName="cubPersMDZ2";
  ...
  FilteredCubset<ReductorD2Type,ScalarType,2> filtCubset2(baseName);
  FilteredCubset<ReductorD3Type,ScalarType,3> filtCubset3(baseName);
