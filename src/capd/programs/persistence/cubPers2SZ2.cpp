...
/*
  typedef ECellMDCodeT<cluster,2,Z2> CubFaceIndexD2Type;
  typedef ReductionPairZ2<CubFaceIndexD2Type> ReductorD2Type;
  typedef ECellMDCodeT<cluster,3,Z2> CubFaceIndexD3Type;
  typedef ReductionPairZ2<CubFaceIndexD3Type> ReductorD3Type;
*/
...
//  std::string rightOutFname=rightBaseName+"out.txt";
  ...
  string executableName="cubPers2SZ2";
...
*/
  FilteredCubset<ReductorD2Type,ScalarType,2> leftFiltCubset2(leftBaseName);
  FilteredCubset<ReductorD2Type,ScalarType,2> rightFiltCubset2(rightBaseName);
  FilteredCubset<ReductorD3Type,ScalarType,3> leftFiltCubset3(leftBaseName);
  FilteredCubset<ReductorD3Type,ScalarType,3> rightFiltCubset3(rightBaseName);
