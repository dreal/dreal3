...
// Copyright (C) 2005-2007 by Marian Mrozek
//
...
#include "capd/homologicalAlgebra/CrHomMD.h"
...
int main(int argc,char** argv){
  ...
  declareCommandLineArg(std::string,engine,"CR");
  declareCommandLineArg(std::string,help,"");
  declareCommandLineArg(int,verbose,2);
  std::string executableName("CrHomMD");
  std::string version(" 0.91 ");
  std::string copyright("(c) Marian Mrozek, 2007");
