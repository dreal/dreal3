...
template DVector capd::matrixAlgorithms::gauss<DMatrix,DVector>(DMatrix,DVector);
...
template IVector capd::matrixAlgorithms::gauss<IMatrix,IVector>(IMatrix,IVector);
