...
// if capacity is equal to zero, the dimension of a vector must be set when create an object.
...
// --------------------------------- how to create a vector ---------------------------------------------
      ...
      // the following line creates an object from a given table of numbers
...
// --------------------------------- arrays of vectors --------------------------------------------------
      ...
      // when one needs create an array of vector which have undefined dimension at compilation time, 
