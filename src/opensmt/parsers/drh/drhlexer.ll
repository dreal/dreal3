...
((([0-9]+)|([0-9]*\.?[0-9]+))([eE][-+]?[0-9]+)?)   { drhlval.str = strdup(yytext); return TK_NUM; }
((([0-9]+)|([0-9]+\.)))                            { drhlval.str = strdup(yytext); return TK_NUM; }
[a-zA-Z]([a-zA-Z0-9_'])*                           { drhlval.str = strdup(yytext); return TK_ID; }

\".*\"          { drhlval.str = strdup( yytext ); return TK_STR; }
