...
#define SNODE_ID_INDEX       (7)
#define SNODE_ID_COST        (8)

#define SNODE_ID_LAST        (8)
//
// Snode type
//
enum stype_t 
...
enum sassoc_t
{
   LEFT_ASSOC     = 0x00000001 // 0000 0000 0000 0000 0000 0000 0000 0001
 , RIGHT_ASSOC    = 0x00000002 // 0000 0000 0000 0000 0000 0000 0000 0010
};
...
public:
  ...
  inline void setProperties       ( const unsigned p ) { properties |= p; }
  //
  ...
  inline bool hasSortIndex       ( ) { assert( isTerm( ) ); Snode * last = getLast( ); return last->hasSymbolId ( SNODE_ID_INDEX ); }
  inline bool hasSortElem        ( ) { assert( isTerm( ) ); Snode * last = getLast( ); return last->hasSymbolId ( SNODE_ID_ELEM  ); }
