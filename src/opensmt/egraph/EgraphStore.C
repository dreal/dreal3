...
//   // TODO: Currently, we assume that the input format is generated by
...
//       Enode * e1 = e->get1st();
//       Enode * e2 = e->get2nd();
//       if(e1->isLeq() && e2->isLeq() &&
//          e1->get1st()->isConstant() &&
//          e2->get2nd()->isConstant() &&
//          e1->get2nd() == e2->get1st()) {
//         Enode * var = e1->get2nd();
...
//         cerr << "postProcessing: " << e << " rangeInfo" << endl;
//         // e->setRangeInfo(true);
//       }
//     }
//   } else {
