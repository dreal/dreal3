...
stat::stat() : m_start_time(std::chrono::high_resolution_clock::now()) { reset(); }
...
void stat::increase_assert() { m_num_of_assert++; }

void stat::increase_push() { m_num_of_push++; }

void stat::increase_pop() { m_num_of_pop++; }

void stat::increase_branch() { m_num_of_branch++; }
