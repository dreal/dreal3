...
class interval {
 public:
    ...
    static interval intersect(interval i, interval const & j) { return i.intersect(j); }
    ...
    friend interval intersect(interval const & i, interval const & j) { return interval::intersect(i, j); }
