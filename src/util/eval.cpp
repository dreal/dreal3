...
double eval_enode(Enode * const e, unordered_map<Enode *, double> const & var_map) {
    if (e->isVar()) {
        ...
        switch (id) {
            ...
            case ENODE_ID_ATAN2:
                assert(e->getArity() == 2);
                return atan2(eval_enode(e->get1st(), var_map), eval_enode(e->get2nd(), var_map));
            case ENODE_ID_MIN:
                assert(e->getArity() == 2);
                return fmin(eval_enode(e->get1st(), var_map), eval_enode(e->get2nd(), var_map));
            case ENODE_ID_MAX:
                assert(e->getArity() == 2);
                return fmax(eval_enode(e->get1st(), var_map), eval_enode(e->get2nd(), var_map));
            case ENODE_ID_MATAN:
                assert(e->getArity() == 1);
            ...
            case ENODE_ID_POW:
                assert(e->getArity() == 2);
                return pow(eval_enode(e->get1st(), var_map), eval_enode(e->get2nd(), var_map));
            case ENODE_ID_ABS:
                assert(e->getArity() == 1);
...
double eval_enode_term(Enode * const e, box const & b) {
    if (e->isVar()) {
        ...
        switch (id) {
            ...
            case ENODE_ID_ATAN2:
                assert(e->getArity() == 2);
                return atan2(eval_enode_term(e->get1st(), b), eval_enode_term(e->get2nd(), b));
            case ENODE_ID_MIN:
                assert(e->getArity() == 2);
                return fmin(eval_enode_term(e->get1st(), b), eval_enode_term(e->get2nd(), b));
            case ENODE_ID_MAX:
                assert(e->getArity() == 2);
                return fmax(eval_enode_term(e->get1st(), b), eval_enode_term(e->get2nd(), b));
            case ENODE_ID_MATAN:
                assert(e->getArity() == 1);
                throw runtime_error("eval_enode: MATAN");
            case ENODE_ID_SAFESQRT:
            ...
            case ENODE_ID_POW:
                assert(e->getArity() == 2);
                return pow(eval_enode_term(e->get1st(), b), eval_enode_term(e->get2nd(), b));
            case ENODE_ID_ABS:
                assert(e->getArity() == 1);
...
double deriv_enode(Enode * const e, Enode * const v,
                   unordered_map<Enode *, double> const & var_map) {
    if (e == v) {
        return 1.0;
    }
    if (e->isVar()) {
        ...
        switch (id) {
            ...
            case ENODE_ID_TIMES: {
                ...
                if (tmp->getArity() != 2) {
                    throw runtime_error(
                        "deriv_enode: only support arity = 2 case for multiplication");
                }
