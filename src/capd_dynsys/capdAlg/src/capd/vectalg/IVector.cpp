...
template void subtractObjects<>(const Vector<Interval,DIM>& v1,const Vector<Interval,DIM>& v2, Vector<Interval,DIM>& result);
template void addObjects<>(const Vector<Interval,DIM>& v1,const Vector<Interval,DIM>& v2, Vector<Interval,DIM>& result);


typedef Vector<Interval,DIM> IVector;
typedef Vector<Interval::BoundType,DIM> DVector;
