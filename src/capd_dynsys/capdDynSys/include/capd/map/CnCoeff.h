...
// it may be used as a function
  ...
  std::string toString(int minFun = 0, int maxFun = -1,
                       int firstVariable = 0, int minRank = 0, int maxRank= -1,
...
std::ostream & print(
    ...
    const CnCoeff<MatrixType> & coeff,    ///< Cn coefficients
    int minRank = 0,
    int maxRank = -1,                     ///< default value is coeff.rank()
    int firstFun = 0,
    int lastFun = -1,                     ///< default value is coeff.dimension()
    int firstVariable = 0
);
