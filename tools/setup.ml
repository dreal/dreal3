...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4cb574bb8144c2551345e229127c3deb) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "./parsing/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "basic"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules =
                        ["Drh_infix_lexer"; "Drh_infix_parser"; "Error"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-passopt"; "-annot"])];
                      },
                   {exec_custom = false; exec_main_is = "inv_main.ml"; });
               Executable
                 ({
                     cs_name = "bmc";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "bmc_main.ml"; })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\162\023;w\183\002\149\203\2405&\131\169i0\226";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
