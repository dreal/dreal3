...
plot 'barn_door_0.001_true_true-q.out' t "delta, 0.001", \
     'barn_door_0.1_true_true-q.out' t "delta, 0.1", \
     'barn_door_1.0_true_true-q.out' t "delta, 1.0", \
     'barn_door_2.0_true_true-q.out' t "delta, 2.0", \
     'barn_door_4.0_true_true-q.out' t "delta, 4.0"
...
plot 'barn_door-q.out' using 1:($2/$3) t "delta, 0.001/0.1" ls 2, \
     'barn_door-q.out' using 1:($2/$4) t "delta, 0.001/1.0" ls 3, \
     'barn_door-q.out' using 1:($2/$5) t "delta, 0.001/2.0" ls 4, \
     'barn_door-q.out' using 1:($2/$6) t "delta, 0.001/4.0" ls 5
