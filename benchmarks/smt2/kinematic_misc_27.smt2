...
(assert (>= (* 5.0 step_4_e.dy) 100.0))
(assert (<= (* 5.0 step_4_e.dx) 230.0))
(assert (<= (* 5.0 step_4_e.dy) 110.0))
(assert (>= (* 5.0 step_3_e.dx) 220.0))
(assert (>= (* 5.0 step_3_e.dy) 33.33333333333333))
(assert (<= (* 5.0 step_3_e.dx) 230.0))
(assert (<= (* 5.0 step_3_e.dy) 43.33333333333333))
(assert (>= (* 5.0 step_2_e.dx) 220.0))
(assert (>= (* 5.0 step_2_e.dy) (- 33.33333333333334)))
(assert (<= (* 5.0 step_2_e.dx) 230.0))
(assert (<= (* 5.0 step_2_e.dy) (- 23.333333333333343)))
