...
(assert (= liipp_4__i 0))
(assert (= liipp_2_c 0))
(assert (or (= liipp_5__i 0) (= liipp_1_c 0) (= liipp_5_c 0) (= liipp_0__i 0)))
(assert (or (= liipp_1__i 0) (= liipp_0_c 0) (= liipp_2__i 0) (= liipp_0__i 0)))
(assert (or (= liipp_5_c 0) (= liipp_1__i 0) (= liipp_4_c 0) (= liipp_3__i 0)))
(assert (or (= liipp_0_c 0) (= liipp_3__i 0) (= liipp_1__i 0) (= liipp_2__i 0)))
(assert (or (= liipp_3__i 0) (= liipp_1__i 0) (= liipp_0__i 0) (= liipp_1_c 0)))
(assert (or (= liipp_1_c 0) (= liipp_0_c 0) (= liipp_3__i 0) (= liipp_2__i 0)))
(assert (or (= liipp_2__i 0) (= liipp_0_c 0) (= liipp_5__i 0) (= liipp_3__i 0)))
(assert (or (= liipp_5_c 0) (= liipp_0__i 0) (= liipp_2__i 0) (= liipp_1_c 0)))
(assert (or (= liipp_1_c 0) (= liipp_2__i 0) (= liipp_3__i 0) (= liipp_5_c 0)))
(assert (or (= liipp_5__i 0) (= liipp_4_c 0) (= liipp_0__i 0) (= liipp_3__i 0)))
(check-sat)
(exit)
