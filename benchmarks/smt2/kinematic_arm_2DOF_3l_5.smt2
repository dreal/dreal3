...
(assert (= (+ (* 1000.0 step_2_s2.dy) (* 2.0 (* 1.0E-6 length3) step_2_s2.q_a step_2_s2.q_k)) (* 5.0 step_2_e.dy)))
...
(assert (> (* 1000.0 step_2_s1.dx) (- 1003.90625)))
(assert (= (+ (* 1000.0 step_2_s2.dx) (* (- 1.0) (* (* 1.0E-6 length3) (^ step_2_s2.q_k 2.0))) (* (* 1.0E-6 length3) (^ step_2_s2.q_a 2.0))) (* 5.0 step_2_e.dx)))
(assert (<= (* 1.0E-6 length3) 390.0))
(assert (>= step_2_s1.q_k (- 1.0)))
...
(assert (= (* 2.0 (* 1.0E-6 length2) step_5_s1.q_a step_5_s1.q_k) (* 1000.0 step_5_s2.dy)))
...
(assert (= (+ (* 1000.0 step_5_s1.dx) (* (- 1.0) (* (* 1.0E-6 length2) (^ step_5_s1.q_k 2.0))) (* (* 1.0E-6 length2) (^ step_5_s1.q_a 2.0))) (* 1000.0 step_5_s2.dx)))
...
(assert (= (+ (* 1000.0 step_5_s2.dx) (* (- 1.0) (* (* 1.0E-6 length3) (^ step_5_s2.q_k 2.0))) (* (* 1.0E-6 length3) (^ step_5_s2.q_a 2.0))) (* 5.0 step_5_e.dx)))
...
(assert (> (* 1000.0 step_5_s2.dy) (- 1003.90625)))
(assert (= (+ (* 1000.0 step_5_s2.dy) (* 2.0 (* 1.0E-6 length3) step_5_s2.q_a step_5_s2.q_k)) (* 5.0 step_5_e.dy)))
...
(assert (= (+ (* 1000.0 step_4_s2.dy) (* 2.0 (* 1.0E-6 length3) step_4_s2.q_a step_4_s2.q_k)) (* 5.0 step_4_e.dy)))
(assert (<= (* 1000.0 step_4_s2.dy) 1000.0))
...
(assert (= (+ (* 1000.0 step_3_s2.dx) (* (- 1.0) (* (* 1.0E-6 length3) (^ step_3_s2.q_k 2.0))) (* (* 1.0E-6 length3) (^ step_3_s2.q_a 2.0))) (* 5.0 step_3_e.dx)))
...
(assert (> (* 1000.0 step_3_s1.dx) (- 1003.90625)))
(assert (= (+ (* 1000.0 step_3_s2.dy) (* 2.0 (* 1.0E-6 length3) step_3_s2.q_a step_3_s2.q_k)) (* 5.0 step_3_e.dy)))
(assert (<= step_3_s1.q_k 1.0))
(assert (< (* 1000.0 step_3_s0.dx) 1003.90625))
(assert (>= (* 5.0 step_3_e.dy) (- 1000.0)))
(assert (>= step_3_s1.q_a (- 1.0)))
