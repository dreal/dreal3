...
(assert ( = ( + s0x ( - ( * length ( ^ s0k 2 ) ) ) ( - ( * length ( ^ s0j 2 ) ) ) ( * length ( ^ s0i 2 ) ) ( * length ( ^ s0a 2 ) ) ) s1x ) )
(assert ( = ( + s0y ( * 2 length s0a s0k ) ( * 2 length s0i s0j ) ) s1y ) )
(assert ( = ( + s0z ( * 2 length s0i s0k ) ( - ( * 2 length s0a s0j ) ) ) s1z ) )
...
(assert ( = ( + s1x ( - ( * length ( ^ s1k 2 ) ) ) ( - ( * length ( ^ s1j 2 ) ) ) ( * length ( ^ s1i 2 ) ) ( * length ( ^ s1a 2 ) ) ) s2x ) )
(assert ( = ( + s1y ( * 2 length s1a s1k ) ( * 2 length s1i s1j ) ) s2y ) )
(assert ( = ( + s1z ( * 2 length s1i s1k ) ( - ( * 2 length s1a s1j ) ) ) s2z ) )
...
(assert ( = ( + s2x ( - ( * length ( ^ s2k 2 ) ) ) ( - ( * length ( ^ s2j 2 ) ) ) ( * length ( ^ s2i 2 ) ) ( * length ( ^ s2a 2 ) ) ) x ) )
(assert ( = ( + s2y ( * 2 length s2a s2k ) ( * 2 length s2i s2j ) ) y ) )
(assert ( = ( + s2z ( * 2 length s2i s2k ) ( - ( * 2 length s2a s2j ) ) ) z ) )
(assert ( = s2a ea ) )
(assert ( = s2i ei ) )
(assert ( = s2j ej ) )
(assert ( = s2k ek ) )
