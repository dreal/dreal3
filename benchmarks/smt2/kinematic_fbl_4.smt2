...
(assert (< step_1_effector.dx 1003.90625))
(assert (< step_1_effector.dy 1003.90625))
(assert (< step_1_s3.dx 1003.90625))
(assert (< step_1_s3.dy 1003.90625))
(assert (< step_2_effector.dx 1003.90625))
(assert (< step_2_effector.dy 1003.90625))
...
(assert (<= (+ step_1_effector.dx (- 1000.0)) 0.0))
(assert (<= (+ step_1_effector.dy (- 1000.0)) 0.0))
...
(assert (<= (+ step_1_s3.dx (- 1000.0)) 0.0))
(assert (<= (+ step_1_s3.dy (- 1000.0)) 0.0))
(assert (<= (+ step_2_a (* (- 1.0) 3.15)) 0.0))
(assert (<= (+ step_2_b (* (- 1.0) 3.15)) 0.0))
(assert (<= (+ step_2_effector.dx (- 1000.0)) 0.0))
(assert (<= (+ step_2_effector.dy (- 1000.0)) 0.0))
...
(assert (<= (+ step_2_s3.dx (- 1000.0)) 0.0))
(assert (<= (+ step_2_s3.dy (- 1000.0)) 0.0))
...
(assert (= (* (- 1.0) step_1_effector.q_i) 0.0))
(assert (= (* (- 1.0) step_1_effector.q_j) 0.0))
(assert (= (* (- 1.0) step_2_effector.q_i) 0.0))
(assert (= (* (- 1.0) step_2_effector.q_j) 0.0))
(assert (= (+ (* (- 1.0) (^ step_1_s2.q_k 2.0) length) (* (- 1.0) step_1_s3.dx) (* (^ step_1_s2.q_a 2.0) length) length (* (^ step_1_s2.q_i 2.0) length) (* (- 2.0) step_1_effector.q_i step_1_effector.q_j length) (* 2.0 step_1_effector.q_a step_1_effector.q_k length) (* (- 1.0) (^ step_1_s2.q_j 2.0) length)) 0.0))
...
(assert (= (+ (* (- 1.0) (^ step_2_s2.q_k 2.0) length) (* (- 1.0) step_2_s3.dx) (* (^ step_2_s2.q_a 2.0) length) length (* (^ step_2_s2.q_i 2.0) length) (* (- 2.0) step_2_effector.q_i step_2_effector.q_j length) (* 2.0 step_2_effector.q_a step_2_effector.q_k length) (* (- 1.0) (^ step_2_s2.q_j 2.0) length)) 0.0))
...
(assert (= (+ (* (- 1.0) step_1_effector.q_a step_1_effector.q_k length) step_1_s3.dx (* (- 1.0) step_1_effector.dx) (* step_1_effector.q_i step_1_effector.q_j length)) 0.0))
(assert (= (+ (* (- 1.0) step_1_s1.q_k) (sin ( / step_1_a 2.0))) 0.0))
(assert (= (+ (* (- 1.0) step_1_s3.dx) (* length (^ step_1_s1.q_a 2.0)) (* (- 1.0) length (^ step_1_s1.q_k 2.0))) 0.0))
(assert (= (+ (* (- 1.0) step_2_effector.q_a step_2_effector.q_k length) step_2_s3.dx (* (- 1.0) step_2_effector.dx) (* step_2_effector.q_i step_2_effector.q_j length)) 0.0))
(assert (= (+ (* (- 1.0) step_2_s1.q_k) (sin ( / step_2_a 2.0))) 0.0))
(assert (= (+ (* (- 1.0) step_2_s3.dx) (* length (^ step_2_s1.q_a 2.0)) (* (- 1.0) length (^ step_2_s1.q_k 2.0))) 0.0))
...
(assert (= (+ (* 2.0 step_1_s1.q_a step_1_s1.q_k length) (* (- 1.0) step_1_s3.dy)) 0.0))
(assert (= (+ (* 2.0 step_1_s2.q_a step_1_s2.q_j length) (* 2.0 step_1_effector.q_j step_1_effector.q_k length) (* 2.0 step_1_effector.q_a step_1_effector.q_i length) (* (- 2.0) step_1_s2.q_k step_1_s2.q_i length)) 0.0))
...
(assert (= (+ (* 2.0 step_2_s1.q_a step_2_s1.q_k length) (* (- 1.0) step_2_s3.dy)) 0.0))
(assert (= (+ (* 2.0 step_2_s2.q_a step_2_s2.q_j length) (* 2.0 step_2_effector.q_j step_2_effector.q_k length) (* 2.0 step_2_effector.q_a step_2_effector.q_i length) (* (- 2.0) step_2_s2.q_k step_2_s2.q_i length)) 0.0))
...
(assert (= (+ (* step_1_effector.q_j step_1_effector.q_k length) (* step_1_effector.q_a step_1_effector.q_i length) (* (- 1.0) step_1_effector.dz)) 0.0))
...
(assert (= (+ (* step_2_effector.q_j step_2_effector.q_k length) (* step_2_effector.q_a step_2_effector.q_i length) (* (- 1.0) step_2_effector.dz)) 0.0))
...
(assert (= (+ step_1_a (* (- 1.0) 57.29582790879778 step_1_alpha)) 0.0))
(assert (= (+ step_1_b (* (- 1.0) 57.29582790879778 step_1_beta)) 0.0))
(assert (= (+ step_1_s3.dy (* ( / 1.0 2.0) (^ step_1_effector.q_a 2.0) length) (* ( / 1.0 2.0) (^ step_1_effector.q_j 2.0) length) (* (- 1.0) step_1_effector.dy) (* ( / (- 1.0) 2.0) (^ step_1_effector.q_i 2.0) length) (* ( / (- 1.0) 2.0) (^ step_1_effector.q_k 2.0) length)) 0.0))
(assert (= (+ step_1_s3.dy (* (- 1.0) (^ step_1_effector.q_k 2.0) length) (* (- 2.0) step_1_s2.q_i step_1_s2.q_j length) (* (^ step_1_effector.q_j 2.0) length) (* (- 1.0) (^ step_1_effector.q_i 2.0) length) (* (- 2.0) step_1_s2.q_k step_1_s2.q_a length) (* (^ step_1_effector.q_a 2.0) length)) 0.0))
(assert (= (+ step_2_a (* (- 1.0) 57.29582790879778 step_2_alpha)) 0.0))
(assert (= (+ step_2_b (* (- 1.0) 57.29582790879778 step_2_beta)) 0.0))
(assert (= (+ step_2_s3.dy (* ( / 1.0 2.0) (^ step_2_effector.q_a 2.0) length) (* ( / 1.0 2.0) (^ step_2_effector.q_j 2.0) length) (* (- 1.0) step_2_effector.dy) (* ( / (- 1.0) 2.0) (^ step_2_effector.q_i 2.0) length) (* ( / (- 1.0) 2.0) (^ step_2_effector.q_k 2.0) length)) 0.0))
(assert (= (+ step_2_s3.dy (* (- 1.0) (^ step_2_effector.q_k 2.0) length) (* (- 2.0) step_2_s2.q_i step_2_s2.q_j length) (* (^ step_2_effector.q_j 2.0) length) (* (- 1.0) (^ step_2_effector.q_i 2.0) length) (* (- 2.0) step_2_s2.q_k step_2_s2.q_a length) (* (^ step_2_effector.q_a 2.0) length)) 0.0))
