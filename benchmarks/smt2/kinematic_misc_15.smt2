...
(assert (<= (- (* 1.0E-6 step_1_beta) (* 1.0E-6 step_2_beta)) 15))
(assert (>= (- (* 1.0E-6 step_1_beta) (* 1.0E-6 step_2_beta)) (- 15)))
(assert (<= (- (* 1.0E-6 step_1_alpha) (* 1.0E-6 step_2_alpha)) 15))
(assert (>= (- (* 1.0E-6 step_1_alpha) (* 1.0E-6 step_2_alpha)) (- 15)))
(assert (<= (- (* 1.0E-6 step_2_beta) (* 1.0E-6 step_3_beta)) 15))
(assert (>= (- (* 1.0E-6 step_2_beta) (* 1.0E-6 step_3_beta)) (- 15)))
(assert (<= (- (* 1.0E-6 step_2_alpha) (* 1.0E-6 step_3_alpha)) 15))
(assert (>= (- (* 1.0E-6 step_2_alpha) (* 1.0E-6 step_3_alpha)) (- 15)))
(assert (<= (- (* 1.0E-6 step_3_beta) (* 60.0 step_4_beta)) 15))
(assert (>= (- (* 1.0E-6 step_3_beta) (* 60.0 step_4_beta)) (- 15)))
(assert (<= (- (* 1.0E-6 step_3_alpha) (* 60.0 step_4_alpha)) 15))
(assert (>= (- (* 1.0E-6 step_3_alpha) (* 60.0 step_4_alpha)) (- 15)))
(check-sat)
(exit)
