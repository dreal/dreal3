...
(assert (or (and (<= x1_4_t 20) (= mode1_5 true))
            (and (> x1_4_t 20) (= mode1_5 false))))
(assert (and (= x2_5_0 x2_4_t)))
(assert (or (and (<= x2_4_t 20) (= mode2_5 true))
            (and (> x2_4_t 20) (= mode2_5 false))))
(assert (and (= x3_5_0 x3_4_t)))
(assert (or (and (<= x3_4_t 20) (= mode3_5 true))
            (and (> x3_4_t 20) (= mode3_5 false))))
...
(assert (or (< x3_5_t (- 20 1)) (> x3_5_t (+ 20 1))))
(check-sat)
(exit)
