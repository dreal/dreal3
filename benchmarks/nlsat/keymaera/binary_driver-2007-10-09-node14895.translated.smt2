...
(assert (or (and (<= ep 0.0) (not (= ep 0.0)))
            (>= (+ ep (* (- 1.0) t7uscore0dollarsk!0)) 0.0)))
...
(assert (not (<= amax 0.0)))
(assert (>= d 0.0))
(assert (not (<= (+ (* (+ (* (- 1.0) b t7uscore0dollarsk!0) vuscore2dollarsk!6)
                       (+ (* (- 1.0) b t7uscore0dollarsk!0) vuscore2dollarsk!6))
                    (* (- 1.0) duscore2dollarsk!5 duscore2dollarsk!5))
                 (* 2.0
                    b
                    (+ muscore2dollarsk!2
                       (* (/ 1.0 2.0) b t7uscore0dollarsk!0 t7uscore0dollarsk!0)
                       (* (- 1.0) t7uscore0dollarsk!0 vuscore2dollarsk!6)
                       (* (- 1.0) zuscore2dollarsk!4))))))
(assert (or (not (>= t7uscore0dollarsk!0 0.0))
            (and (>= (+ vuscore2dollarsk!6 (* (- 1.0) b t7uscore0dollarsk!0))
                     0.0)
                 (>= (+ ep (* (- 1.0) t7uscore0dollarsk!0)) 0.0))))
(assert (or (= b 0.0)
            (and (or (= b 0.0)
            ...
            (= b 0.0)
            (= (+ vuscore2dollarsk!6 (* (- 1.0) b t7uscore0dollarsk!0)) 0.0)
            (and (not (<= (+ vuscore2dollarsk!6
                             (* (- 1.0) b t7uscore0dollarsk!0))
                          0.0))
                 (not (<= b 0.0)))
            (and (not (>= (+ vuscore2dollarsk!6
                             (* (- 1.0) b t7uscore0dollarsk!0))
