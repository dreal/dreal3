...
(assert (= (+ (* x1 x1) (* (- 2) (* x1 y1)) (* y1 y1) (* x2 x2) (* (- 2) (* x2 y2)) (* y2 y2) (* (- 3) (* ruscore1dollarsk_1 ruscore1dollarsk_1)) (* 2 (* d1 luscore0dollarsk_2 x1)) (* (- 2) (* d1 luscore0dollarsk_2 y1)) (* 2 (* d2 luscore0dollarsk_2 x2)) (* (- 2) (* d2 luscore0dollarsk_2 y2)) (* d1 d1 luscore0dollarsk_2 luscore0dollarsk_2) (* d2 d2 luscore0dollarsk_2 luscore0dollarsk_2)) 0))
...
(assert (= (+ x1 (* (- 1) y1) (* d1 luscore0dollarsk_2) (* (- 1) (* e1 luscore0dollarsk_2))) 0))
(assert (= (+ x2 (* (- 1) y2) (* d2 luscore0dollarsk_2) (* (- 1) (* e2 luscore0dollarsk_2))) 0))
(assert (not (= (+ (* (- 1) x2) y2 (* (- 1) (* d2 luscore0dollarsk_2)) (* e2 luscore0dollarsk_2)) 0)))
(check-sat)
