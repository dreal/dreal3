...
(assert (or (not (>= t24uscore0dollarsk!0 0)) (<= (+ t24uscore0dollarsk!0 yuscore2dollarsk!2) 10)))
...
(assert (not (>= (+ (* 3 t24uscore0dollarsk!0) yuscore2dollarsk!2 (* 2 xuscore2dollarsk!3)) 5)))
(assert (or (and (>= yuscore2dollarsk!2 10) (not (= yuscore2dollarsk!2 10))) (<= (+ t24uscore0dollarsk!0 yuscore2dollarsk!2) 10)))
(assert (or (not (>= t24uscore0dollarsk!0 0)) (<= yuscore2dollarsk!2 10)))
(check-sat)
