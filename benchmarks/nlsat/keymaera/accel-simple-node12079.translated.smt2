...
(assert (not (= (+ (* (- 10.0) t3uscore0dollarsk_0) vuscore2dollarsk_5)
                (+ (* (+ t3uscore0dollarsk_0 tuscore2dollarsk_2)
                      (+ 10.0 (* (- 10.0) stuscore2dollarsk_1)))
                   (* stuscore2dollarsk_1
                      (+ 200.0
                         (* (- 10.0) t3uscore0dollarsk_0)
                         (* (- 10.0) tuscore2dollarsk_2)))))))
(check-sat)
(exit)
