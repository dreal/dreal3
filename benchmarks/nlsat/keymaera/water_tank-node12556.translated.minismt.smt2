...
(assert (or (not (>= t10uscore0dollarsk!0 0)) (<= (+ xuscore2dollarsk!3 t10uscore0dollarsk!0) 2)))
...
(assert (not (<= (+ t10uscore0dollarsk!0 yuscore2dollarsk!2) 12)))
(assert (or (and (>= xuscore2dollarsk!3 2) (not (= xuscore2dollarsk!3 2))) (<= (+ xuscore2dollarsk!3 t10uscore0dollarsk!0) 2)))
(assert (or (not (>= t10uscore0dollarsk!0 0)) (<= xuscore2dollarsk!3 2)))
(check-sat)
