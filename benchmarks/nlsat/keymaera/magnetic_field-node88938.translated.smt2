...
(declare-fun t21uscore0dollarsk_0 () Real)
(declare-fun a () Real)
...
(assert (= vyuscore2dollarsk_6
           (+ (- 2.0)
              (* a
                 (+ (- 2.0)
                    (* t21uscore0dollarsk_0 vxuscore2dollarsk_5)
                    xuscore2dollarsk_4)))))
...
(assert (= vxuscore2dollarsk_5
           (+ 2.0
              (* (- 1.0)
                 a
                 (+ 2.0
                    (* t21uscore0dollarsk_0 vyuscore2dollarsk_6)
                    yuscore2dollarsk_3))
              (* 4.0 buscore2dollarsk_2 (+ 1.0 (* (- 1.0) a))))))
(assert (= stateuscore2dollarsk_1 1.0))
(assert (or (<= vxuscore2dollarsk_5 0.0) (not (>= t21uscore0dollarsk_0 0.0))))
(assert (>= t21uscore0dollarsk_0 0.0))
...
(assert (= y 0.0))
(assert (= b 0.0))
(assert (not (= stateuscore2dollarsk_1 0.0)))
(assert (not (= vxuscore2dollarsk_5
                (+ 2.0
                   (* (- 1.0) a (+ 2.0 yuscore2dollarsk_3))
                   (* 4.0 buscore2dollarsk_2 (+ 1.0 (* (- 1.0) a)))))))
(assert (not (= (* a
                   (+ (* t21uscore0dollarsk_0 vxuscore2dollarsk_5)
                      xuscore2dollarsk_4
                      (* (- 1.0) t21uscore0dollarsk_0 vyuscore2dollarsk_6)
