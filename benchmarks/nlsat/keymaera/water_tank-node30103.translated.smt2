...
(assert (or (not (>= t35uscore0dollarsk!0 0.0)) (<= xuscore2dollarsk!3 2.0)))
(assert (>= t35uscore0dollarsk!0 0.0))
...
(assert (not (<= (+ t35uscore0dollarsk!0 yuscore2dollarsk!2) 12.0)))
(assert (or (and (>= xuscore2dollarsk!3 2.0) (not (= xuscore2dollarsk!3 2.0)))
            (<= (+ t35uscore0dollarsk!0 xuscore2dollarsk!3) 2.0)))
(assert (or (not (>= t35uscore0dollarsk!0 0.0))
            (<= (+ t35uscore0dollarsk!0 xuscore2dollarsk!3) 2.0)))
(check-sat)
(exit)
