...
(assert (or (not (>= t16uscore0dollarsk_0 0)) (<= (+ t16uscore0dollarsk_0 yuscore2dollarsk_2) 10)))
...
(assert (not (>= (+ (* 3 t16uscore0dollarsk_0) yuscore2dollarsk_2 (* 2 xuscore2dollarsk_3)) 5)))
(assert (or (and (>= yuscore2dollarsk_2 10) (not (= yuscore2dollarsk_2 10))) (<= (+ t16uscore0dollarsk_0 yuscore2dollarsk_2) 10)))
