...
(declare-fun y () Real)
(declare-fun k () Real)
(assert (or (and (>= tuscore2dollarsk!3 1.0) (not (= tuscore2dollarsk!3 1.0)))
            (<= (+ t1uscore0dollarsk!0 tuscore2dollarsk!3) 1.0)))
(assert (>= t1uscore0dollarsk!0 0.0))
(assert (not (<= 1.0 tuscore2dollarsk!3)))
(assert (= moduscore2dollarsk!1 1.0))
...
(assert (<= y 100.0))
(assert (= k 1.0))
(assert (not (<= (+ t1uscore0dollarsk!0 tcuscore2dollarsk!2) 1.0)))
(assert (or (not (>= t1uscore0dollarsk!0 0.0))
            (and (<= (+ t1uscore0dollarsk!0 tuscore2dollarsk!3) 1.0)
                 (<= (+ t1uscore0dollarsk!0 tcuscore2dollarsk!2) 1.0))))
(assert (or (and (>= tcuscore2dollarsk!2 1.0) (not (= tcuscore2dollarsk!2 1.0)))
            (<= (+ t1uscore0dollarsk!0 tcuscore2dollarsk!2) 1.0)))
(assert (or (not (>= t1uscore0dollarsk!0 0.0))
            (and (<= tuscore2dollarsk!3 1.0) (<= tcuscore2dollarsk!2 1.0))))
(check-sat)
(exit)
