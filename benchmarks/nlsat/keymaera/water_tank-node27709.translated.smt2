...
(assert (or (not (>= t31uscore0dollarsk!0 0.0))
            (<= (+ t31uscore0dollarsk!0 xuscore2dollarsk!3) 2.0)))
(assert (>= t31uscore0dollarsk!0 0.0))
...
(assert (not (<= (+ (* (- 3.0) t31uscore0dollarsk!0) yuscore2dollarsk!2)
                 (+ 10.0 xuscore2dollarsk!3))))
(assert (or (and (>= xuscore2dollarsk!3 2.0) (not (= xuscore2dollarsk!3 2.0)))
            (<= (+ t31uscore0dollarsk!0 xuscore2dollarsk!3) 2.0)))
(assert (or (not (>= t31uscore0dollarsk!0 0.0)) (<= xuscore2dollarsk!3 2.0)))
(check-sat)
(exit)
