...
(assert (or (not (>= t6uscore0dollarsk!0 0)) (<= (+ yuscore2dollarsk!2 t6uscore0dollarsk!0) 10)))
...
(assert (not (<= (+ yuscore2dollarsk!2 t6uscore0dollarsk!0) 12)))
(assert (or (and (>= yuscore2dollarsk!2 10) (not (= yuscore2dollarsk!2 10))) (<= (+ yuscore2dollarsk!2 t6uscore0dollarsk!0) 10)))
(assert (or (not (>= t6uscore0dollarsk!0 0)) (<= yuscore2dollarsk!2 10)))
(check-sat)
