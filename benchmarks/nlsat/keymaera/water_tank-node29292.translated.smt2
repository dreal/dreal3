...
(assert (or (not (>= t21uscore0dollarsk_0 0.0))
            (<= (+ t21uscore0dollarsk_0 xuscore2dollarsk_3) 2.0)))
...
(assert (not (<= (+ (* (- 2.0) t21uscore0dollarsk_0) yuscore2dollarsk_2) 12.0)))
(assert (or (and (>= xuscore2dollarsk_3 2.0) (not (= xuscore2dollarsk_3 2.0)))
            (<= (+ t21uscore0dollarsk_0 xuscore2dollarsk_3) 2.0)))
(assert (or (not (>= t21uscore0dollarsk_0 0.0)) (<= xuscore2dollarsk_3 2.0)))
(check-sat)
(exit)
