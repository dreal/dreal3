...
(declare-fun e2 () Real)
(declare-fun y1 () Real)
(assert (not (implies (and (and (and (= (+ d1 (* om x2) (* (- 1) (* om c2))) 0) (= (+ d2 (* (- 1) (* om x1)) (* om c1)) 0)) (= (+ e1 (* (- 1) (* om c2)) (* om y2)) 0)) (= (+ e2 (* om c1) (* (- 1) (* om y1))) 0)) (or (= (+ d1 (* (- 1) e1)) 0) (not (<= (+ (* d1 d1) (* (- 2) (* d1 e1)) (* e1 e1) (* d2 d2) (* (- 2) (* d2 e2)) (* e2 e2)) 0))))))
(check-sat)
