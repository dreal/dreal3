...
(assert (or (not (>= t6uscore0dollarsk!0 0.0))
            (<= (+ t6uscore0dollarsk!0 yuscore2dollarsk!2) 10.0)))
...
(assert (not (<= (+ t6uscore0dollarsk!0 yuscore2dollarsk!2) 12.0)))
(assert (or (and (>= yuscore2dollarsk!2 10.0) (not (= yuscore2dollarsk!2 10.0)))
            (<= (+ t6uscore0dollarsk!0 yuscore2dollarsk!2) 10.0)))
(assert (or (not (>= t6uscore0dollarsk!0 0.0)) (<= yuscore2dollarsk!2 10.0)))
(check-sat)
(exit)
