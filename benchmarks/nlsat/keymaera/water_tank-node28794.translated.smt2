...
(assert (or (not (>= t16uscore0dollarsk!0 0.0))
            (<= (+ t16uscore0dollarsk!0 yuscore2dollarsk!2) 10.0)))
(assert (>= t16uscore0dollarsk!0 0.0))
...
(assert (not (<= (+ t16uscore0dollarsk!0 yuscore2dollarsk!2) 12.0)))
(assert (or (and (>= yuscore2dollarsk!2 10.0) (not (= yuscore2dollarsk!2 10.0)))
            (<= (+ t16uscore0dollarsk!0 yuscore2dollarsk!2) 10.0)))
(assert (or (not (>= t16uscore0dollarsk!0 0.0)) (<= yuscore2dollarsk!2 10.0)))
(check-sat)
