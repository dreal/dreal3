...
(assert (or (not (>= t18uscore0dollarsk!0 0.0)) (>= yuscore2dollarsk!2 5.0)))
(assert (>= t18uscore0dollarsk!0 0.0))
...
(assert (not (<= (+ (* (- 2.0) t18uscore0dollarsk!0) yuscore2dollarsk!2) 12.0)))
(assert (or (and (<= yuscore2dollarsk!2 5.0) (not (= yuscore2dollarsk!2 5.0)))
            (<= (+ (* 4.0 t18uscore0dollarsk!0) (* (- 2.0) yuscore2dollarsk!2))
                (- 10.0))))
(assert (or (not (>= t18uscore0dollarsk!0 0.0))
