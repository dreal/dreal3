...
(assert (not (<= amax 0.0)))
(assert (>= d 0.0))
(assert (not (<= (+ (* (+ (* (- 1.0) b t3uscore0dollarsk!0) vuscore2dollarsk!6)
                       (+ (* (- 1.0) b t3uscore0dollarsk!0) vuscore2dollarsk!6))
                    (* (- 1.0) duscore2dollarsk!5 duscore2dollarsk!5))
                 (* 2.0
                    b
                    (+ muscore2dollarsk!2
                       (* (/ 1.0 2.0) b t3uscore0dollarsk!0 t3uscore0dollarsk!0)
                       (* (- 1.0) t3uscore0dollarsk!0 vuscore2dollarsk!6)
