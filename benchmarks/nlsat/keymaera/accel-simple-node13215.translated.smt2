...
(assert (= (+ (* 10.0 t1uscore0dollarsk!0) vuscore2dollarsk!5) 200.0))
...
(assert (not (= (+ (* 5.0 t1uscore0dollarsk!0 t1uscore0dollarsk!0)
                   (* t1uscore0dollarsk!0 vuscore2dollarsk!5)
                   zuscore2dollarsk!4)
                (+ (* 4000.0 suscore2dollarsk!3)
                   (* (+ t1uscore0dollarsk!0 tuscore2dollarsk!2)
                      (+ t1uscore0dollarsk!0 tuscore2dollarsk!2)
                      (+ 5.0 (* (- 5.0) stuscore2dollarsk!1)))
                   (* stuscore2dollarsk!1
                      (+ 2000.0
                         (* 200.0 t1uscore0dollarsk!0)
                         (* 200.0 tuscore2dollarsk!2)
                         (* (- 5.0)
                            (+ t1uscore0dollarsk!0 tuscore2dollarsk!2)
                            (+ t1uscore0dollarsk!0 tuscore2dollarsk!2))))))))
