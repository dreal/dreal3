...
(assert (or (not (>= t13uscore0dollarsk!0 0.0))
            (<= (+ (* 2.0 t13uscore0dollarsk!0) (* (- 1.0) yuscore2dollarsk!2))
                (- 5.0))))
(assert (>= t13uscore0dollarsk!0 0.0))
...
(assert (not (<= (+ (* (- 3.0) t13uscore0dollarsk!0) yuscore2dollarsk!2)
                 (+ 10.0 xuscore2dollarsk!3))))
(assert (or (and (<= yuscore2dollarsk!2 5.0) (not (= yuscore2dollarsk!2 5.0)))
            (<= (+ (* 4.0 t13uscore0dollarsk!0) (* (- 2.0) yuscore2dollarsk!2))
                (- 10.0))))
(assert (or (not (>= t13uscore0dollarsk!0 0.0)) (>= yuscore2dollarsk!2 5.0)))
(check-sat)
