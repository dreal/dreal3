...
(assert (or (not (>= t35uscore0dollarsk_0 0.0)) (<= xuscore2dollarsk_3 2.0)))
(assert (>= t35uscore0dollarsk_0 0.0))
...
(assert (not (>= (+ (* 3.0 t35uscore0dollarsk_0) yuscore2dollarsk_2)
                 (+ 5.0 (* (- 2.0) xuscore2dollarsk_3)))))
(assert (or (and (>= xuscore2dollarsk_3 2.0) (not (= xuscore2dollarsk_3 2.0)))
            (<= (+ xuscore2dollarsk_3 t35uscore0dollarsk_0) 2.0)))
(assert (or (not (>= t35uscore0dollarsk_0 0.0))
            (<= (+ xuscore2dollarsk_3 t35uscore0dollarsk_0) 2.0)))
(check-sat)
(exit)
