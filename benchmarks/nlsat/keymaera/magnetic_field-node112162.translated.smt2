...
(assert (= vyuscore2dollarsk_6
           (+ (- 2.0)
              (* a
                 (+ (- 2.0)
                    (* t24uscore0dollarsk_0 vxuscore2dollarsk_5)
                    xuscore2dollarsk_4)))))
...
(assert (= vxuscore2dollarsk_5
           (+ 2.0
              (* (- 1.0)
                 a
                 (+ 2.0
                    (* t24uscore0dollarsk_0 vyuscore2dollarsk_6)
                    yuscore2dollarsk_3))
              (* 4.0 buscore2dollarsk_2 (+ 1.0 (* (- 1.0) a))))))
(assert (= stateuscore2dollarsk_1 1.0))
(assert (or (<= vxuscore2dollarsk_5 0.0) (not (>= t24uscore0dollarsk_0 0.0))))
...
(assert (= (* a (+ xuscore2dollarsk_4 (* (- 1.0) yuscore2dollarsk_3)))
           (* (+ (- 4.0) (* (- 4.0) buscore2dollarsk_2)) (+ 1.0 (* (- 1.0) a)))))
(assert (= vx 2.0))
(assert (= vy (- 2.0)))
(assert (= x 0.0))
(assert (= y 0.0))
...
(assert (not (= (* a
                   (+ (* t24uscore0dollarsk_0 vxuscore2dollarsk_5)
                      xuscore2dollarsk_4
                      (* (- 1.0) t24uscore0dollarsk_0 vyuscore2dollarsk_6)
