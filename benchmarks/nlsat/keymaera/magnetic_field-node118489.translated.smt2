...
(assert (= vyuscore2dollarsk!6
           (+ (- 2.0)
              (* a
                 (+ (- 2.0)
                    (* t14uscore0dollarsk!0 vxuscore2dollarsk!5)
                    xuscore2dollarsk!4)))))
...
(assert (= vxuscore2dollarsk!5
           (+ 2.0
              (* (- 1.0)
                 a
                 (+ 2.0
                    (* t14uscore0dollarsk!0 vyuscore2dollarsk!6)
                    yuscore2dollarsk!3))
...
(assert (or (<= vxuscore2dollarsk!5 0.0) (not (>= t14uscore0dollarsk!0 0.0))))
(assert (>= t14uscore0dollarsk!0 0.0))
...
(assert (not (= (* a
                   (+ (* t14uscore0dollarsk!0 vxuscore2dollarsk!5)
                      xuscore2dollarsk!4
                      (* (- 1.0) t14uscore0dollarsk!0 vyuscore2dollarsk!6)
