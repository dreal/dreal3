...
(assert (= vyuscore10dollarsk_3 (- 2.0)))
(assert (= vxuscore10dollarsk_2 2.0))
(assert (= (* a (+ xuscore10dollarsk_1 yuscore10dollarsk_0))
...
(assert (= y 0.0))
(assert (= b 0.0))
(assert (not (= (* a (+ xuscore10dollarsk_1 (* (- 1.0) yuscore10dollarsk_0)))
