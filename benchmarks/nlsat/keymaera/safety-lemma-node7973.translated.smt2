...
(assert (or (= b 0.0)
            ...
            (= (+ vuscore2dollarsk!7 (* (- 1.0) b t1uscore0dollarsk!0)) 0.0)
            (= b 0.0)
            (and (not (>= b 0.0))
                 (not (>= (+ vuscore2dollarsk!7
                             (* (- 1.0) b t1uscore0dollarsk!0))
                          0.0)))
            (and (not (<= b 0.0))
                 (not (<= (+ vuscore2dollarsk!7
                             (* (- 1.0) b t1uscore0dollarsk!0))
...
(assert (>= A 0.0))
(assert (>= ep 0.0))
(assert (not (<= (+ (* (+ (* (- 1.0) b t1uscore0dollarsk!0) vuscore2dollarsk!7)
                       (+ (* (- 1.0) b t1uscore0dollarsk!0) vuscore2dollarsk!7))
                    (* (- 1.0) duscore2dollarsk!6 duscore2dollarsk!6))
                 (* 2.0
                    b
                    (+ muscore2dollarsk!3
                       (* (/ 1.0 2.0) b t1uscore0dollarsk!0 t1uscore0dollarsk!0)
                       (* (- 1.0) t1uscore0dollarsk!0 vuscore2dollarsk!7)
                       (* (- 1.0) zuscore2dollarsk!5))))))
(assert (or (not (>= t1uscore0dollarsk!0 0.0))
            (and (>= (+ vuscore2dollarsk!7 (* (- 1.0) b t1uscore0dollarsk!0))
                     0.0)
                 (>= (+ ep (* (- 1.0) t1uscore0dollarsk!0)) 0.0))))
