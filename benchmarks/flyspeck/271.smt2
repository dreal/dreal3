...
(assert
(and
(and (<= (/ 252 100) y1) (<= y1 (/ 25527 10000)))(and (<= 2 y12) (<= y12 (/ 246350884418 100000000000)))(and (<= 2 y23) (<= y23 (/ 246350884418 100000000000)))(and (<= 2 y34) (<= y34 (/ 246350884418 100000000000)))(and (<= 2 y41) (<= y41 (/ 246350884418 100000000000)))(not (< (+ (* 2 (* (/ 314159265 100000000) (- (/ 074623 1000000)))) (+ (* (+ (/ 019702 1000000) (+ (- (/ 023711 1000000)) (+ (- (/ 031932 1000000)) (/ 035942 1000000)))) y1) (+ (* 2 (* (+ (- (/ 081204 1000000)) (/ 081204 1000000)) y12)) (+ (* 2 (* (+ (/ 081204 1000000) (- (/ 081204 1000000))) y23)) (+ (* 2 (* (+ (- (/ 081204 1000000)) (/ 081204 1000000)) y34)) (+ (* 2 (* (+ (/ 081204 1000000) (- (/ 081204 1000000))) y41)) (+ (/ 740105 1000000) (+ (- (/ 47876 100000)) (+ (/ 836608 1000000) (- (/ 629086 1000000))))))))))) 0)))
)
(check-sat)
(exit)
