...
(assert (or (and (= mode1_4 true) (connect holder_13 flow_2))
            (and (= mode1_4 false) (connect holder_13 flow_3))))
(assert (not (and (connect holder_13 flow_2) (connect holder_13 flow_3))))
(assert (or (and (= mode2_4 true)  (connect holder_14 flow_4))
            (and (= mode2_4 false) (connect holder_14 flow_5))))
...
(assert (or (and (= mode1_5 true) (connect holder_16 flow_2))
            (and (= mode1_5 false) (connect holder_16 flow_3))))
(assert (not (and (connect holder_16 flow_2) (connect holder_16 flow_3))))
(assert (or (and (= mode2_5 true)  (connect holder_17 flow_4))
            (and (= mode2_5 false) (connect holder_17 flow_5))))
