...
(assert (= tau_{0}_0 0))
(assert (= mode_1_{0} 2))
(assert (<= (^ (^ (- x1_{0}_0 5) 2) 0.5) 0.1))
(assert (= mode_2_{0} 2))
(assert (<= (^ (^ (- x2_{0}_0 5) 2) 0.5) 0.1))
(assert (= mode_3_{0} 2))
(assert (<= (^ (^ (- x3_{0}_0 5) 2) 0.5) 0.1))
"""

goal_cond = """
(assert (> (^ (^ (- x1_{0}_t 5) 2) 0.5) 2))
(assert (> (^ (^ (- x2_{0}_t 5) 2) 0.5) 2))
(assert (> (^ (^ (- x3_{0}_t 5) 2) 0.5) 2))
"""
