...
(assert (and (= [xAIL_{0}_t xRDR_{0}_t tau_{0}_t r_{0}_t psi_{0}_t 
                 phi_{0}_t p_{0}_t gAIL_{0}_t gRDR_{0}_t gDir_{0}_t beta_{0}_t] 
                (pintegral 0. time_{0} 
                   [xAIL_{0}_0 xRDR_{0}_0 tau_{0}_0 r_{0}_0 psi_{0}_0 
                    phi_{0}_0 p_{0}_0 gAIL_{0}_0 gRDR_{0}_0 gDir_{0}_0 beta_{0}_0] 
