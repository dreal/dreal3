...
(assert (and (= [xAIL_2_t xRDR_2_t tau_2_t r_2_t psi_2_t 
                 phi_2_t p_2_t gAIL_2_t gRDR_2_t gDir_2_t beta_2_t] 
                (pintegral 0. time_2 
                   [xAIL_2_0 xRDR_2_0 tau_2_0 r_2_0 psi_2_0 
                    phi_2_0 p_2_0 gAIL_2_0 gRDR_2_0 gDir_2_0 beta_2_0] 
...
(assert (and (= [xAIL_3_t xRDR_3_t tau_3_t r_3_t psi_3_t 
                 phi_3_t p_3_t gAIL_3_t gRDR_3_t gDir_3_t beta_3_t] 
                (pintegral 0. time_3 
                   [xAIL_3_0 xRDR_3_0 tau_3_0 r_3_0 psi_3_0 
                    phi_3_0 p_3_0 gAIL_3_0 gRDR_3_0 gDir_3_0 beta_3_0] 
...
(assert (and (= [xAIL_4_t xRDR_4_t tau_4_t r_4_t psi_4_t 
                 phi_4_t p_4_t gAIL_4_t gRDR_4_t gDir_4_t beta_4_t] 
                (pintegral 0. time_4 
                   [xAIL_4_0 xRDR_4_0 tau_4_0 r_4_0 psi_4_0 
                    phi_4_0 p_4_0 gAIL_4_0 gRDR_4_0 gDir_4_0 beta_4_0] 
                   [holder_13 holder_14 holder_15]))
             (connect holder_15 flow_1)))
(assert (or (and (= modeA_4 true)  (connect holder_13 flow_2))
            (and (= modeA_4 false) (connect holder_13 flow_3))))
(assert (not (and (connect holder_13 flow_2) (connect holder_13 flow_3))))
(assert (or (and (= modeR_4 true)  (connect holder_14 flow_4))
            (and (= modeR_4 false) (connect holder_14 flow_5))))
...
(assert (and (= [xAIL_5_t xRDR_5_t tau_5_t r_5_t psi_5_t 
                 phi_5_t p_5_t gAIL_5_t gRDR_5_t gDir_5_t beta_5_t] 
                (pintegral 0. time_5 
                   [xAIL_5_0 xRDR_5_0 tau_5_0 r_5_0 psi_5_0 
                    phi_5_0 p_5_0 gAIL_5_0 gRDR_5_0 gDir_5_0 beta_5_0] 
                   [holder_16 holder_17 holder_18]))
             (connect holder_18 flow_1)))
(assert (or (and (= modeA_5 true)  (connect holder_16 flow_2))
            (and (= modeA_5 false) (connect holder_16 flow_3))))
(assert (not (and (connect holder_16 flow_2) (connect holder_16 flow_3))))
(assert (or (and (= modeR_5 true)  (connect holder_17 flow_4))
            (and (= modeR_5 false) (connect holder_17 flow_5))))
