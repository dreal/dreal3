...
\title{$\delta$-Complete Reachability Analysis of Hybrid Systems}
...
polynomials, trancsendental functions, solutions of Lipschitz-continuous ODEs) are
...
First of all, the study of first-order theories with arbitrary computable real functions provides us a rich language for describing hybrid systems. 
...
Second, we introduce notion of $\delta$-complete reachability analysis. Reachability 
...
Thrid, the framework and theoretical results directly lead to the development of 
...
when we encode reachability for hybrid automata withnontrivial invariant
