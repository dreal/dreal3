...
\begin{mathpar}
\inferrule{\inferrule{
  \forall x (\vec x\in I_1) \rightarrow \neg c)
    \and
  \forall x (\vec x \in I_2) \rightarrow
\neg c)
  }
  {
  \forall x (\vec x\in I_1)\vee \vec x \in I_2 \rightarrow \neg c)
  }\mbox{$\vee$-intro}
  \and
  {
  \inferrule{\ }{\forall \vec x (\vec x \in I_1 \vee \vec x\in
I_2)\rightarrow \vec x\in \vec I}\mbox{I-Ax}
  }
  }
{
